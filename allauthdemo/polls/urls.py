...
urlpatterns = [
    ...
    url(r'^(?P<event_id>[0-9a-f-]+)/bulletin_board/$', views.bulletin_boards, name='bulletin-boards'),
    url(r'^(?P<event_id>[0-9a-f-]+)/bulletin_board/(?P<poll_id>[0-9a-f-]+)/$', views.bulletin_board, name='bulletin-board'),
    url(r'^(?P<event_id>[0-9a-f-]+)/bulletin_board/(?P<poll_id>[0-9a-f-]+)/voter/(?P<voter_alias>[0-9a-f-]+)/$', views.voter_board, name='voter-board'),
